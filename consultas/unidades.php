...
// SQL query to select data from the productos table with uniMed = 'unidades'
$sql = "SELECT * FROM productos WHERE uniMed = 'unidades'";
...
<div class="bg bg3"></div>
        ...
        <a href="unimed.php" class="button">back</a>
    </section>
</body>
